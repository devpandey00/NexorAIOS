      ...
      <section className="nexor-panel p-6">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-[9px] leading-5 text-[var(--text-secondary)]">One workspace for prospect discovery, public social-profile enrichment, AI content, and approval-first outreach. Email and WhatsApp can send automatically; cold social DMs remain a controlled manual queue because platform APIs do not provide unrestricted outbound messaging to arbitrary profiles.</p>
          </div>
