...
type Tab = 'LEADS' | 'CONTENT' | 'INTELLIGENCE' | 'OUTREACH' | 'JOBS';
      ...
      <section className="nexor-panel p-6">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-[var(--text)]">Research → create → approve → publish → learn → grow</h1>
            <p className="mt-2 max-w-3xl text-[9px] leading-5 text-[var(--text-secondary)]">A single social operating workspace for public trend intelligence, content production, scheduling, verified publishing, performance learning, lead discovery and approval-first outreach. Platform restrictions are respected; unsupported automation is never faked.</p>
          </div>
