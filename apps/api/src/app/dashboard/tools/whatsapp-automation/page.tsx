  ...
  return (
    <main className="space-y-5">
      <section className="nexor-panel p-6">
        ...
        <p className="mt-2 max-w-3xl text-[9px] leading-5 text-[var(--text-muted)]">One manual step: approve a draft. After approval, the automation worker sends it through the official WhatsApp Cloud API. Use “Run Due Sends Now” to execute the due queue immediately; the background worker continues every 5 minutes.</p>
