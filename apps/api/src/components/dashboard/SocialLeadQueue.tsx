...
export default function SocialLeadQueue() {
  ...
  async function copyMessage(draft: Draft) {
    try {
      ...
      setMessage('Clipboard access failed. Copy the message manually.');
    }
  }
