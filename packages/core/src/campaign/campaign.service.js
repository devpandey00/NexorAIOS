...
var CampaignService = /** @class */ (function () {
  ...
  CampaignService.prototype.create = function (input) {
  ...
  CampaignService.prototype.createDiscoveryJob = function (campaignId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          prisma.job.create({
            data: {
              ...
              type: client_1.JobType.LEAD_DISCOVERY,
  ...
  CampaignService.prototype.updateStatus = function (id, status) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          prisma.campaign.update({
            ...
            data: __assign(
              __assign(
                { status: status },
                status === client_1.CampaignStatus.RUNNING ? { startedAt: new Date() } : {},
              ),
              status === client_1.CampaignStatus.COMPLETED ||
                status === client_1.CampaignStatus.FAILED ||
                status === client_1.CampaignStatus.CANCELLED
